...
public class ParserTest {
    ...
    public void testParseServerResponse() throws Exception {
        ...
        String body = "Name";
        String rawString = firstHeader + NetworkMessage.RESPONSE_SPLIT_CHARACTER +
                secondHeader + NetworkMessage.RESPONSE_HEADER_SPLIT_CHARACTER + body;
    ...
    public void testParseSingleResponse_withBody() throws Exception {
        ...
        String stringToParse = header.name() + NetworkMessage.RESPONSE_HEADER_SPLIT_CHARACTER + body;
