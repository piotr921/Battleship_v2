...
import com.spanishinquisition.battleship.server.ClientConnectionHandler;
...
public class PlacingShipsStateTest {
    ...
    public void initialize() {
        ...
        try {
            ...
            AppLogger.logger.log(Level.WARNING, "couldn't create server socket", e);
        }
        ...
        CLIENT_IDS.forEach(integer -> {
            ...
            try {
                ...
                AppLogger.logger.log(Level.WARNING, "couldn't connect with server", e);
            }
    ...
    private void assignSocketAndNameTo(String nameString) {
        try {
            ...
            AppLogger.logger.log(Level.WARNING, "could't connect to server", e);
        }
    }
    ...
    public void closeConnections() {
        try {
            ...
            AppLogger.logger.log(Level.WARNING, "couldn't close server", e);
        }
    }
}